...
document.addEventListener("DOMContentLoaded", () => {
  const components = document.querySelectorAll(".componant-1, .componant-2, .componant-3");
...
//founder slide up animation

document.addEventListener("DOMContentLoaded", () => {
  const headings = document.querySelector(".founders-headings");
  ...
  const handleScroll = () => {
    ...
    // Show headings
    if (headings.getBoundingClientRect().top < windowHeight - 100) {
